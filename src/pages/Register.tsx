...
import { Mail, Lock, AlertCircle, ArrowRight, UserPlus, Shield } from "lucide-react";
  ...
  return (
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 -right-32 w-96 h-96 bg-orange-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 -left-32 w-96 h-96 bg-amber-500/10 rounded-full blur-3xl" />
      </div>
        ...
        <div className="text-center mb-8">
          ...
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-orange-500/10 rounded-full border border-orange-500/20 mb-2">
              ...
              <span className="text-xs font-medium text-orange-400">Únete a la comunidad</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">
              Crea tu cuenta
            </h1>
            <p className="text-gray-400 text-sm sm:text-base">
              Protege a tus mascotas con nosotros
            </p>
          </div>
        </div>
                ...
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Shield className={`w-5 h-5 transition-colors duration-200 ${
                      errors.confirmPassword ? "text-red-400" : "text-gray-500 group-focus-within:text-orange-400"
                    }`} />
                  </div>
                  <input
                    id="confirmPassword"
